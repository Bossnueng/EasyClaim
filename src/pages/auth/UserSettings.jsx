      ...
      >
        ...
        >
          ...
          <span
            style={{
              padding: "4px 12px",
              backgroundColor: user?.role === "staff" ? "#e0f2fe" : "#ecfdf5",
              color: user?.role === "staff" ? "#0369a1" : "#047857",
              borderRadius: "20px",
              fontSize: "13px",
              fontWeight: "600",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          <Button
            ...
            onClick={() => message.info("ระบบเปลี่ยนรหัสผ่านกำลังพัฒนา")}
          >
          ...
          <Button
            ...
            onClick={() => message.info("ระบบการแจ้งเตือนกำลังพัฒนา")}
          >
