...
const CustomerClaimDetail = () => {
      ...
      default:
        return (
          <Tag color="processing" style={{ margin: 0 }}>
            {getCustomerStepInfo(status).text}
          </Tag>
        );
    }
  };
  ...
  // กำหนดรายการ Steps 4 ขั้นตอน ทั้ง reject และ process เต็ม
  const getStepItems = () => {
    if (isRejected) {
      return [
        {
          title: "ยื่นคำร้อง",
          description:
            data.statusTimestamps?.["สร้างรายการเคลม"] ||
            data.createdDate ||
            "-",
    ...
    return [
      {
        title: "ยื่นคำร้อง",
        description:
          data.statusTimestamps?.["สร้างรายการเคลม"] || data.createdDate || "-",
        icon: <CheckCircleOutlined />,
      },
      {
        title: "พิจารณา / รับสินค้า",
        description:
          data.statusTimestamps?.["รับสินค้าจริงแล้ว"] ||
          "ตรวจสอบและรับสินค้าคืน",
        icon: <FileSearchOutlined />,
      },
      {
        title: "กำลังจัดส่งสินค้าเคลม",
        description:
          data.statusTimestamps?.["กำลังจัดส่งสินค้าเคลม"] ||
          "อยู่ระหว่างการขนส่ง",
        icon: <CarOutlined />,
      },
      {
        title: "จัดส่งสำเร็จ",
        description:
          data.statusTimestamps?.["จัดส่งสินค้าเคลมสำเร็จ"] ||
          "ลูกค้ารับสินค้าแล้ว",
        icon: <SmileOutlined />,
      },
    ];
  ...
  return (
    ...
    >
      ...
      <Card
        title={
          <span className="font-bold text-slate-800">สถานะการดำเนินงาน</span>
        }
        className="rounded-2xl shadow-sm border-gray-200 w-full"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
        ...
        {/* --- แสดงรายละเอียดสินค้าและข้อมูลการแจ้ง --- */}
        <div className="lg:col-span-2">
          <Card
            title={
              <span className="font-bold text-slate-800">
                รายละเอียดสินค้าและข้อมูลการแจ้ง
              </span>
            }
            className="rounded-2xl shadow-sm border-gray-200 h-full"
            bodyStyle={{ padding: "24px" }}
        ...
        <div className="flex flex-col gap-6 lg:col-span-1">
          <Card
            title={
              <span className="font-bold text-slate-800">รูปภาพหลักฐาน</span>
            }
